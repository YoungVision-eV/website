...
<div use:melt={$root} data-testid="benefits">
  {#if $open}
    <div transition:slide use:melt={$content} class="pt-16 pb-12 lg:px-16">
      ...
      <div class="grid grid-cols-1 gap-y-4 lg:grid-cols-2 lg:gap-x-5 lg:text-xl">
        <p>
          Dein Beitrag, unsere Vision: Deine Unterstützung ermöglicht es uns, inspirierende Projekte
          und Veranstaltungen für junge Menschen zu schaffen und eine unterstützende Gemeinschaft
          aufzubauen.
        </p>
        <p>
  ...
  <button
    use:melt={$trigger}
    class="mt-12 flex w-full flex-col items-center justify-center lg:mt-8"
  >
