...
<footer class="w-full bg-green-50 py-6">
  <div class="mx-auto max-w-[80rem] px-4 lg:px-20">
    ...
    <div class="mt-4 justify-between md:flex">
      <dl class="text-white">
        ...
        <dd>
          <a class="hover:underline" href="mailto:kontakt@youngvision.org"
      ...
      <div class="mt-3 md:mt-0 md:w-3/5 lg:w-1/2">
        <div class="bg-green-50">
          <h2 class="text-orange text-xl font-bold">Für unseren Newsletter anmelden</h2>
          <div class="mt-2">
            ...
            <div class="relative">
              <input
                ...
                id="email"
                autocomplete="email"
                class="block w-full rounded-md border-0 py-1.5 text-lg text-gray-900 ring-1 shadow-sm ring-gray-300 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-600 focus:ring-inset sm:text-sm sm:leading-6"
